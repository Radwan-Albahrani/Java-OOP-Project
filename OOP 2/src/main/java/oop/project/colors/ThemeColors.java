...
public class ThemeColors
{
    ...
    public static final Color MIDDLE_BLUE = new Color(128, 128, 128);
    public static final Color BLUE = new Color(0, 0, 255);
    public static final Color LIGHT_BLUE_GRAY = new Color(200, 200, 200);
    public static final Color LAVENDER_BLUSH = new Color(255, 240, 245);
    public static final Color CINNABAR = new Color(227, 66, 52);
    public static final Color ORANGE_PEEL = new Color(255, 159, 67);
...
>>>>>>> ff52fb3e5c286126781311295948d1d608cf27f0
